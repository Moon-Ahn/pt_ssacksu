...
const App = () => {
  ...
  const questions = [
    ...
    {
      id: 9,
      q: "만약 나만의 '치료 공간'을 딱 하나만 꾸밀 수 있다면?",
      options: [
        { text: "섬세한 핸들링과 관찰이 가능한 넓은 매트와 치료 베드", types: ['ns'] },
        { text: "슬링, 바벨, 고난도 재활이 가능한 최신식 트레이닝 짐(Gym)", types: ['sports'] },
        { text: "동선이 효율적이고 체계적으로 관리되는 표준 물리치료실", types: ['routine'] },
        { text: "동작 분석 센서와 데이터 분석용 고사양 워크스테이션", types: ['research'] }
      ]
    },
    {
      id: 10,
